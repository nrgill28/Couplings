...
dependencies {
  ...
  modImplementation(include(fabricApi.module("fabric-api-base", "0.107.0+1.21.1"))!!)
  modImplementation(include(fabricApi.module("fabric-networking-api-v1", "0.107.0+1.21.1"))!!)
